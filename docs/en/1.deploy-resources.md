...
For the current setup, you can deploy using the ARM templates ([Bicep file](https://github.com/Azure/azure-quickstart-templates/blob/master/quickstarts/microsoft.azure-ai-agent-service/standard-agent/main.bicep) or [JSON file](https://github.com/Azure/azure-quickstart-templates/blob/master/quickstarts/microsoft.azure-ai-agent-service/standard-agent/azuredeploy.json)) available below. Additionally, by clicking the ```[deploy to Azure]``` button on the following page, you can deploy to the specified Azure subscription and resource group with a single click.
