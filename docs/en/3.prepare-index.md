...
If you want to use API key authentication instead of Entra authentication for this OpenAI Service account, please specify as follows and specify the account's API key in ```apiKey```.
```json
"vectorizers": [
    {
        "name": "vectorizer",
